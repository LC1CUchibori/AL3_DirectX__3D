...
Matrix4x4 MakeAffineMatrix(const Vector3& scale_, const Vector3& rotation_, const Vector3& translation_){
	...
	// XYZ回転行列作成
	RotateMatX = {1, 0, 0, 0,
		0, cos(rotation_.x), sin(rotation_.x), 0,
		0,-sin(rotation_.x), cos(rotation_.x), 0,
		0, 0, 0, 1};

	RotateMatY = {cos(rotation_.y), 0,-sin(rotation_.y), 0,
		0, 1, 0, 0,
		sin(rotation_.y), 0, cos(rotation_.y), 0,
		0, 0, 0, 1};

	RotateMatZ = {cos(rotation_.z), sin(rotation_.z), 0, 0,
